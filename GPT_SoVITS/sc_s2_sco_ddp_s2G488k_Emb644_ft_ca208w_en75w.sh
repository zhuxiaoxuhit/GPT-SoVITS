...
python -m launch --nnodes $WORLD_SIZE --node_rank $RANK --master_addr $MASTER_ADDR --nproc_per_node 8 --master_port $MASTER_PORT s2_train_ddp1_s2G488k_Emb644_ft_ca208w_en75w.py 
#$config_path 
