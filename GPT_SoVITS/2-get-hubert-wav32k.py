...
inp_text=sys.argv[1]                        #os.environ.get("inp_text")
inp_wav_dir=sys.argv[2]                       #os.environ.get("inp_wav_dir")
opt_dir=sys.argv[3]               #os.environ.get("opt_dir")
...
#os.environ["CUDA_VISIBLE_DEVICES"]= #os.environ.get("_CUDA_VISIBLE_DEVICES")
from feature_extractor import cnhubert
cnhubert.cnhubert_base_path="/mnt/share_afs/share-workspace/zhuxiaoxu/code/GPT-SoVITS/GPT_SoVITS/pretrained_models/chinese-hubert-base/"
is_half=False
#is_half=eval(os.environ.get("is_half","True"))
...
def is_file_empty(file_path):
        return os.path.getsize(file_path) == 0 if os.path.exists(file_path) else False
