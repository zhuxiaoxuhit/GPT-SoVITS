...
srun -j s2ddp -p $LOCAL_PARTITION_ID  --workspace-id $LOCAL_WORKSPACE_ID -y -f pt -r N1lS.Ib.I20.8 -N $world_size -d Allreduce sh /mnt/share_afs/share-workspace/zhuxiaoxu/code/GPT-SoVITS/GPT_SoVITS/sc_s2_sco_ddp.sh $config_path
