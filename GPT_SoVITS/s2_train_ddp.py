...
def get_args():
    ...
    # must add below to your argument list with torch.distributed.launch
...
def main():
    ...
    #else:
    #    n_gpus = 1
    # WORLD_SIZE is set by torch.distributed.launch
...
def run(rank, n_gpus, hps):
    ...
    #if torch.cuda.is_available() else SynthesizerTrn(
    #    hps.data.filter_length // 2 + 1,
    #    hps.train.segment_size // hps.data.hop_length,
    #    n_speakers=hps.data.n_speakers,
    #    **hps.model,
