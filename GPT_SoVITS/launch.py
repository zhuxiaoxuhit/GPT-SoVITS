...
def main():
    ...
    # get device id list allocated by SLURM
    devices_list = ( os.environ['CUDA_VISIBLE_DEVICES'] if 
                         'CUDA_VISIBLE_DEVICES' in os.environ else None )
    ...
    for local_rank in range(0, args.nproc_per_node):
        ...
        if devices_list:
            # gpu id re-mapping, NO boundary checking
            gpu_id = devices_list.replace(' ', '').split(',')[local_rank]
            cmd.append("--gpu={}".format(gpu_id))
