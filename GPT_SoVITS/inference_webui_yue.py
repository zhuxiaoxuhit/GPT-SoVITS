...
def get_tts_wav2(ref_wav_path, prompt_text, prompt_language, text, text_language, how_to_cut=i18n("不切"), top_k=5, top_p=0.6, temperature=0.6, ref_free = False):
    #if prompt_text is None or len(prompt_text) == 0:
    #    ref_free = True
    t0 = ttime()
    prompt_language = dict_language[prompt_language]
...
def get_tts_wav_s2(ref_wav_path, prompt_text, prompt_language, text, text_language, how_to_cut=i18n("不切"), top_k=5, top_p=0.6, temperature=0.6, ref_free = False):
    #if prompt_text is None or len(prompt_text) == 0:
    #    ref_free = True
    t0 = ttime()
    prompt_language = dict_language[prompt_language]
