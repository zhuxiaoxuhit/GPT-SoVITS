...
from inference_webui_yue import change_gpt_weights, change_sovits_weights, get_tts_wav, get_tts_wav2, get_tts_wav_s2
...
def synthesize(GPT_model_path, SoVITS_model_path, ref_audio_path, ref_text_path, ref_language, target_text_path, target_language, output_path):
    ...
    # Synthesize audio
    synthesis_result = get_tts_wav_s2(ref_wav_path=ref_audio_path, 
                                   prompt_text=ref_text, 
                                   prompt_language=i18n(ref_language), 
                                   text=target_text, 
                                   text_language=i18n(target_language), top_p=1, temperature=1)
